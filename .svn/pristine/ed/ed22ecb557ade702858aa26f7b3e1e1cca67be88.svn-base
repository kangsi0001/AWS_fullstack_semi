		...
		<div class="cardbox-header p-5 ms-3">
			<div class="media">
				<div class="d-flex me-3" style="object-fit: cover; object-position: center">
					<a href="/member/profile/${member.email}/damso">
		...
		$("#removeModal div:last").click(function () {
 		...
 		$("#modify").click(function () {
			...
			boardService.get($("#editModal").data("bno"), function (data) {
				console.log(data)
				imgStr = '<img src="/display?name=' + data.attaches[0]['name'] + '&path=' + data.attaches[0]['path'] + '&uuid=' + data.attaches[0]['uuid'] + '&image=' + data.attaches[0]['image'] + '&thumb=on">'
