			...
			<div class="d-flex flex-row align-items-center px-5 mt-4">
				...
				<div class="col-9 d-flex flex-column align-items-start pb-2 ps-4 ms-5">
					...
					<div class="d-flex flex-row pb-3">
						...
						<div class="pe-4 me-3 " id="followerBtn" >팔로워 <span class="fw-bold" id ="followCount"></span></div>
						<div class="pe-4 me-3" id="followingBtn">팔로우 <span class="fw-bold" id ="followerCount"></span></div>
					</div>
...
$(function() {
	...
	boardService.getList({id : '${profileEmail.id}'}, function (result) {
		let str = "";
		for (let i in result) {
